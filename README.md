...
<h3 align="center">project_title</h3>
  ...
  <p align="center">
    project_description
    <br />
    <a href="https://github.com/PEDSnet/PEDSpace"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/PEDSnet/PEDSpace">View Demo</a>
    ·
...
2. Clone the repo
   ```sh
   git clone https://github.com/PEDSnet/PEDSpace.git
   ```
...
See the [open issues](https://github.com/PEDSnet/PEDSpace/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/PEDSnet/PEDSpace](https://github.com/PEDSnet/PEDSpace)
