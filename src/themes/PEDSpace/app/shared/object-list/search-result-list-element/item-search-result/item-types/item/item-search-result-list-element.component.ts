...
@listableObjectComponent('PublicationSearchResult', ViewMode.ListElement, Context.Any, 'PEDSpace')
@listableObjectComponent(ItemSearchResult, ViewMode.ListElement, Context.Any, 'PEDSpace')
@Component({
